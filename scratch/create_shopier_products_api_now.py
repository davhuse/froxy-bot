...
new_products = [
    {
        ...
        "image_url": "https://veridia-bot.onrender.com/static/lisansarena_exxen.png"
    },
    {
...
with open("uploaded_products_results.json", "w", encoding="utf-8") as f:
    json.dump(out, f, indent=2, ensure_ascii=False)
print("\nDone! Results written to uploaded_products_results.json")
