...
print("Starting Shopier Product Update to force cover image refresh with cache-buster...")
for idx, p in enumerate(products):
    ...
    # We append ?v={cache_buster} to force Shopier to re-download the image
    image_url_with_cache_buster = f"https://froxy-bot.onrender.com/static/lisansarena_{slug}.png?v={cache_buster}"
    ...
    payload = {
        ...
        "media": [
            {
                "type": "image",
                "url": image_url_with_cache_buster,
                "placement": 1
            }
        ],
        "priceData": {
    ...
    try:
        with urllib.request.urlopen(req, context=ctx) as r:
            print(f"  [SUCCESS] Updated ID {product_id} with URL {image_url_with_cache_buster}")
...
print("Product image refresh completed.")
