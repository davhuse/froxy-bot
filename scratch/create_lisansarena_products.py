...
print("Starting LisansArena Product Creation via REST API...")
...
with open("created_lisansarena_products.json", "w", encoding="utf-8") as f:
    json.dump(created_list, f, indent=2, ensure_ascii=False)
print("Created products saved to created_lisansarena_products.json")
