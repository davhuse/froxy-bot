    ...
    return jsonify({
        ...
        'keyvadi_mini_app': {
            'url': os.environ.get(
                ...
                f"{(os.environ.get('RENDER_EXTERNAL_URL') or 'https://froxy-bot-kgky.onrender.com').rstrip('/')}/keyvadi/",
            ),
            'mounted': True,
        },
        'group_state_files': {
...
def keep_alive():
    ...
    render_url = os.environ.get("RENDER_EXTERNAL_URL", "https://froxy-bot-kgky.onrender.com")
