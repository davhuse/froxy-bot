...
req = urllib.request.Request('https://api.shopier.com/v1/products?limit=3', headers={
...
try:
    with urllib.request.urlopen(req, context=ctx) as resp:
        ...
        print("Froxy Shopier Products Count:", len(products))
        for p in products:
            print(" -", p.get("title"), "URL:", p.get("url"))
