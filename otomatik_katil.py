    ...
    if os.path.exists("bot_config.json"):
        try:
            with open("bot_config.json", "r", encoding="utf-8-sig") as f:
                ...
                string_session_key_2 = cfg.get("ad_string_session2_new", cfg.get("ad_string_session2", cfg.get("ad_string_session_2", "")))
                string_session_key_3 = cfg.get("ad_string_session3_new", cfg.get("ad_string_session3", cfg.get("ad_string_session_3", "")))
