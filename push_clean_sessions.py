...
# Use the verified active tokens from ZZBu
...
target_env['AD_STRING_SESSION_FROXY'] = zzbu['AD_STRING_SESSION_FROXY']
target_env['AD_STRING_SESSION_KEYVADI'] = zzbu['AD_STRING_SESSION_KEYVADI']
target_env['AD_STRING_SESSION_LISANSARENA'] = zzbu['AD_STRING_SESSION_LISANSARENA']
...
with urllib.request.urlopen(req) as resp:
    ...
    print(f"Applied {len(res)} clean env vars to {srv_id}!")
